...
namespace MetacriticAPI.Controllers
{
    public class MovieController : ApiController
    {
        ...
        public MovieController(IMetacriticService metacriticService)
        {
        ...
        public IHttpActionResult Get(string title)
        {
            ...
            IMetacriticData[] result = m_metacriticService.GetResult(id, string.Format("/movie/{0}", title),
                out statusCode);
        ...
        public IHttpActionResult GetDetails(string title, string details)
        {
            HttpStatusCode statusCode;
            string id = m_metacriticService.GetId();
            IMetacriticData[] result = m_metacriticService.GetResult(id, string.Format("/movie/{0}/{1}",
        ...
        public IHttpActionResult Get(string title, int? year, string details)
        {
            HttpStatusCode statusCode;
            string id = m_metacriticService.GetId();
            IMetacriticData[] result = m_metacriticService.GetResult(id, string.Format("/movie/{0}/{1}/{2}",
